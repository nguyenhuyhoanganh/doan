...
const sideBarItems = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Album',
        link: PATH.dashboard.album.root,
        icon: (
          <span className='visible h-6 w-6  flex-shrink-0 transition duration-75'>
            <BsJournalAlbum size={24} />
          </span>
        ),
        items: [
          { title: 'List', link: PATH.dashboard.album.root },
          { title: 'Create', link: PATH.dashboard.album.create },
          { title: 'Details', link: PATH.dashboard.album.details, hiden: true },
          { title: 'Edit', link: PATH.dashboard.album.edit, hiden: true }
        ]
      },
      {
        title: 'Composer',
        link: PATH.dashboard.composer.root,
        icon: (
          <svg
            aria-hidden='true'
            className='visible h-6 w-6  flex-shrink-0 transition duration-75'
        ...
        items: [
          { title: 'List', link: PATH.dashboard.composer.root },
          { title: 'Create', link: PATH.dashboard.composer.create },
          { title: 'Details', link: PATH.dashboard.composer.details, hiden: true },
          { title: 'Edit', link: PATH.dashboard.composer.edit, hiden: true }
        ]
      },
      {
        title: 'Category',
        link: PATH.dashboard.category.root,
        icon: (
          <span className='visible h-6 w-6  flex-shrink-0 transition duration-75'>
            <BsTagFill size={24} />
          </span>
        ...
        items: [
          { title: 'List', link: PATH.dashboard.category.root },
          { title: 'Create', link: PATH.dashboard.category.create },
          { title: 'Details', link: PATH.dashboard.category.details, hiden: true },
          { title: 'Edit', link: PATH.dashboard.category.edit, hiden: true }
        ]
      }
    ]
  }
