      ...
      <div className='px-3 py-3 lg:px-5 lg:pl-3'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center justify-start'>
            ...
            <NavLink to={path.dashBoard} className='ml-2 mr-3 mb-2 flex h-8 md:mr-24'>
            ...
            renderPopover={
              <div className='mb-4 list-none divide-y divide-gray-200 rounded bg-gray-50 text-base shadow'>
                <div className='overflow-hidden px-4 py-3'>
                  <p className='truncate text-sm text-gray-900'>Nguyễn Huy Hoàng Anh</p>
                  <p className='truncate text-sm font-medium text-gray-900'>{profile?.email}</p>
                </div>
                <ul className='py-1'>
                  <li>
                    <NavLink to={path.dashBoard} className='block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 '>
                      Dashboard
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to={path.profile} className='block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100'>
                      Profile
                    </NavLink>
                  </li>
                  <li>
          ...
          >
            {
              <div className='flex rounded-full bg-gray-800 text-sm hover:ring-4 hover:ring-gray-300'>
                <img className='h-8 w-8 rounded-full' src={profile?.photoUrl} alt='user' />
              </div>
            }
          </Popover>
        </div>
