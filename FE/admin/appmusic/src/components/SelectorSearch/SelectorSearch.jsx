  ...
  return (
    <div className={classNameWrapper} ref={selectorRef}>
      ...
      <div className='flex'>
        ...
        {hasCreateNew && (
          <div className='flex items-center justify-center pl-3' onClick={() => setOpen(false)}>
            <button
              type='button'
              className='h-full min-w-[7.25rem] rounded-lg bg-green-500/80 px-1 text-sm font-medium text-white shadow hover:bg-green-500 hover:drop-shadow-lg'
            >
              {titleCreate}
            </button>
          </div>
