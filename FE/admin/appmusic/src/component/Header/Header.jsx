import { FloatingPortal, useFloating, arrow, shift } from '@floating-ui/react-dom-interactions'
      ...
      <div className='px-3 py-3 lg:px-5 lg:pl-3'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center justify-start'>
            ...
            <a href='/' className='ml-2 mr-3 mb-2 flex h-8 md:mr-24'>
          ...
          <div className='flex items-center'>
            <div className='ml-3 flex items-center' onMouseEnter={showPopover} onMouseLeave={hidePopover}>
              <div className='flex rounded-full bg-gray-800 text-sm hover:ring-4 hover:ring-gray-300' ref={reference}>
                <span className='sr-only'>Open user menu</span>
                <img className='h-8 w-8 rounded-full' src='http://localhost:8080/api/files/1' alt='user' />
              </div>
              <FloatingPortal>
                <AnimatePresence>
                  {open && (
                    ...
                    >
                      <span
                        ref={arrowRef}
                        className='absolute z-50 mt-5 translate-y-[-95%] border-[0.75rem] border-y-[1rem] border-x-transparent border-t-transparent border-b-gray-50'
                        style={{
                          top: middlewareData.arrow?.y,
                          left: middlewareData.arrow?.x
                        }}
                      />
                      <div className='z-40 mb-4 mt-5 list-none divide-y divide-gray-200 rounded bg-gray-50 text-base shadow'>
